...
class StartUpClient : Application() {
    ...
    private fun openMainApp(primaryStage: Stage) {
        ...
        //AVSpeakClient().start(primaryStage) FriendsWindow(AppState.username.toString()).openFriendsForm(primaryStage)
    }

    companion object {
        @JvmStatic
        fun main(args: Array<String>) {
            launch(StartUpClient::class.java)
        }
    }
}